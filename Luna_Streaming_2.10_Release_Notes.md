...
| [jdbc-clickhouse](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for ClickHouse | 2.10.6.3  | pulsar-io-jdbc-clickhouse-2.10.6.3.nar        |
| [jdbc-mariadb](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for MariaDB | 2.10.6.3  | pulsar-io-jdbc-mariadb-2.10.6.3.nar           |
| [jdbc-postgres](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for PostgreSQL | 2.10.6.3  | pulsar-io-jdbc-postgres-2.10.6.3.nar          |
| [jdbc-sqlite](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for SQLite | 2.10.6.3  | pulsar-io-jdbc-sqlite-2.10.6.3.nar            |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.6.3  | pulsar-io-kafka-2.10.6.3.nar                  |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.6.3  | pulsar-io-kinesis-2.10.6.3.nar                |
...
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.6.3 | pulsar-io-data-generator-2.10.6.3.nar    |
| [debezium-mongodb](https://pulsar.apache.org/docs/io-connectors) | Debezium MongoDb Source | 2.10.6.3 | pulsar-io-debezium-mongodb-2.10.6.3.nar  |
| [debezium-mssql](https://pulsar.apache.org/docs/io-connectors) | Debezium Microsoft SQL Server Source | 2.10.6.3 | pulsar-io-debezium-mssql-2.10.6.3.nar    |
| [debezium-mysql](https://pulsar.apache.org/docs/io-connectors) | Debezium MySql Source | 2.10.6.3 | pulsar-io-debezium-mysql-2.10.6.3.nar    |
| [debezium-oracle](https://pulsar.apache.org/docs/io-connectors) | Debezium Oracle Source | 2.10.6.3 | pulsar-io-debezium-oracle-2.10.6.3.nar   |
| [debezium-postgres](https://pulsar.apache.org/docs/io-connectors) | Debezium Postgres Source | 2.10.6.3 | pulsar-io-debezium-postgres-2.10.6.3.nar |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.6.3 | pulsar-io-kafka-2.10.6.3.nar             |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.6.3 | pulsar-io-kinesis-2.10.6.3.nar           |
</details>
...
| Name | Description | Version   | File                             | 
| ---- | ----------- |-----------|----------------------------------|
| [kafka](https://github.com/datastax/starlight-for-kafka) | Kafka Proxy Extension | 2.10.3.12 | pulsar-kafka-proxy-2.10.3.12.nar |
...
| Name | Description | Version   | File                                        |
| ---- | ----------- |-----------|---------------------------------------------|
| [kafka](https://github.com/datastax/starlight-for-kafka) | Kafka Protocol Handler | 2.10.3.12 | pulsar-protocol-handler-kafka-2.10.3.12.nar |
| [rabbitmq](https://github.com/datastax/starlight-for-rabbitmq) | Starlight for RabbitMQ Proxy Extension | 2.10.1.0  | starlight-rabbitmq-2.10.1.0.nar             |
</details>
...
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.6.0 | pulsar-io-data-generator-2.10.6.0.nar         |
| [elastic_search](https://pulsar.apache.org/docs/io-connectors) | Writes data into Elastic Search | 2.10.6.0 | pulsar-io-elastic-search-2.10.6.0.nar         |
| [http](https://pulsar.apache.org/docs/io-connectors) | Writes data to an HTTP server (Webhook) | 2.10.6.0 | pulsar-io-http-2.10.6.0.nar                   |
| [jdbc-clickhouse](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for ClickHouse | 2.10.6.0 | pulsar-io-jdbc-clickhouse-2.10.6.0.nar        |
| [jdbc-mariadb](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for MariaDB | 2.10.6.0 | pulsar-io-jdbc-mariadb-2.10.6.0.nar           |
| [jdbc-postgres](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for PostgreSQL | 2.10.6.0 | pulsar-io-jdbc-postgres-2.10.6.0.nar          |
| [jdbc-sqlite](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for SQLite | 2.10.6.0 | pulsar-io-jdbc-sqlite-2.10.6.0.nar            |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.6.0 | pulsar-io-kafka-2.10.6.0.nar                  |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.6.0 | pulsar-io-kinesis-2.10.6.0.nar                |
...
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.6.0 | pulsar-io-data-generator-2.10.6.0.nar     |
| [debezium-mongodb](https://pulsar.apache.org/docs/io-connectors) | Debezium MongoDb Source | 2.10.6.0 | pulsar-io-debezium-mongodb-2.10.6.0.nar  |
| [debezium-mssql](https://pulsar.apache.org/docs/io-connectors) | Debezium Microsoft SQL Server Source | 2.10.6.0 | pulsar-io-debezium-mssql-2.10.6.0.nar    |
| [debezium-mysql](https://pulsar.apache.org/docs/io-connectors) | Debezium MySql Source | 2.10.6.0 | pulsar-io-debezium-mysql-2.10.6.0.nar    |
| [debezium-oracle](https://pulsar.apache.org/docs/io-connectors) | Debezium Oracle Source | 2.10.6.0 | pulsar-io-debezium-oracle-2.10.6.0.nar   |
| [debezium-postgres](https://pulsar.apache.org/docs/io-connectors) | Debezium Postgres Source | 2.10.6.0 | pulsar-io-debezium-postgres-2.10.6.0.nar |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.6.0 | pulsar-io-kafka-2.10.6.0.nar             |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.6.0 | pulsar-io-kinesis-2.10.6.0.nar           |
</details>
<details><summary>Proxy extensions</summary>
...
| Name | Description | Version   | File                             | 
| ---- | ----------- |-----------|----------------------------------|
| [kafka](https://github.com/datastax/starlight-for-kafka) | Kafka Proxy Extension | 2.10.3.11 | pulsar-kafka-proxy-2.10.3.11.nar |
| [rabbitmq](https://github.com/datastax/starlight-for-rabbitmq) | Starlight for RabbitMQ Proxy Extension | 2.10.1.0  | starlight-rabbitmq-2.10.1.0.nar  |
</details>
<details><summary>Protocol handlers</summary>
...
| Name | Description | Version   | File                                        |
| ---- | ----------- |-----------|---------------------------------------------|
| [kafka](https://github.com/datastax/starlight-for-kafka) | Kafka Protocol Handler | 2.10.3.11 | pulsar-protocol-handler-kafka-2.10.3.11.nar |
| [rabbitmq](https://github.com/datastax/starlight-for-rabbitmq) | Starlight for RabbitMQ Proxy Extension | 2.10.1.0  | starlight-rabbitmq-2.10.1.0.nar             |
</details>
<details><summary>CLI extensions</summary>
...
| [cassandra-enhanced](https://github.com/datastax/pulsar-sink) | A DataStax Pulsar Sink to load records from Pulsar topics to Apache Cassandra(R) or DataStax Enterprise(DSE) | 1.6.11   | cassandra-enhanced-pulsar-sink-1.6.11-nar.nar |
| [cloud-storage](https://github.com/streamnative/pulsar-io-cloud-storage) | Writes data into cloud storage | 2.10.1   | pulsar-io-cloud-storage-2.10.1.nar            |
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.5.10 | pulsar-io-data-generator-2.10.5.10.nar         |
| [elastic_search](https://pulsar.apache.org/docs/io-connectors) | Writes data into Elastic Search | 2.10.5.10 | pulsar-io-elastic-search-2.10.5.10.nar         |
| [http](https://pulsar.apache.org/docs/io-connectors) | Writes data to an HTTP server (Webhook) | 2.10.5.10 | pulsar-io-http-2.10.5.10.nar                   |
| [jdbc-clickhouse](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for ClickHouse | 2.10.5.10 | pulsar-io-jdbc-clickhouse-2.10.5.10.nar        |
| [jdbc-mariadb](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for MariaDB | 2.10.5.10 | pulsar-io-jdbc-mariadb-2.10.5.10.nar           |
| [jdbc-postgres](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for PostgreSQL | 2.10.5.10 | pulsar-io-jdbc-postgres-2.10.5.10.nar          |
| [jdbc-sqlite](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for SQLite | 2.10.5.10 | pulsar-io-jdbc-sqlite-2.10.5.10.nar            |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.10 | pulsar-io-kafka-2.10.5.10.nar                  |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.10 | pulsar-io-kinesis-2.10.5.10.nar                |
| [snowflake](https://github.com/datastax/snowflake-connector) | Snowflake Connector | 0.1.13   | pulsar-snowflake-connector-0.1.13.nar         |
| [lakehouse](https://github.com/streamnative/pulsar-io-lakehouse) | Lakehouse Connector | 2.10.5.17   | pulsar-io-lakehouse-2.10.5.17.nar         |
| [lakehouse-cloud](https://github.com/streamnative/pulsar-io-lakehouse) | Lakehouse Cloud Connector | 2.10.5.17   | pulsar-io-lakehouse-2.10.5.17-cloud.nar         |
</details>
...
| ---- | ----------- |----------|------------------------------------------|
| [cassandra-source](https://github.com/datastax/cdc-for-apache-cassandra) | Read data from Cassandra | 2.2.9    | pulsar-cassandra-source-2.2.9.nar        |
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.5.10 | pulsar-io-data-generator-2.10.5..nar     |
| [debezium-mongodb](https://pulsar.apache.org/docs/io-connectors) | Debezium MongoDb Source | 2.10.5.10 | pulsar-io-debezium-mongodb-2.10.5.10.nar  |
| [debezium-mssql](https://pulsar.apache.org/docs/io-connectors) | Debezium Microsoft SQL Server Source | 2.10.5.10 | pulsar-io-debezium-mssql-2.10.5.10.nar    |
| [debezium-mysql](https://pulsar.apache.org/docs/io-connectors) | Debezium MySql Source | 2.10.5.10 | pulsar-io-debezium-mysql-2.10.5.10.nar    |
| [debezium-oracle](https://pulsar.apache.org/docs/io-connectors) | Debezium Oracle Source | 2.10.5.10 | pulsar-io-debezium-oracle-2.10.5.10.nar   |
| [debezium-postgres](https://pulsar.apache.org/docs/io-connectors) | Debezium Postgres Source | 2.10.5.10 | pulsar-io-debezium-postgres-2.10.5.10.nar |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.10 | pulsar-io-kafka-2.10.5.10.nar             |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.10 | pulsar-io-kinesis-2.10.5.10.nar           |
</details>
<details><summary>Proxy extensions</summary>
...
| [cassandra-enhanced](https://github.com/datastax/pulsar-sink) | A DataStax Pulsar Sink to load records from Pulsar topics to Apache Cassandra(R) or DataStax Enterprise(DSE) | 1.6.11   | cassandra-enhanced-pulsar-sink-1.6.11-nar.nar |
| [cloud-storage](https://github.com/streamnative/pulsar-io-cloud-storage) | Writes data into cloud storage | 2.10.1   | pulsar-io-cloud-storage-2.10.1.nar            |
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.5.9 | pulsar-io-data-generator-2.10.5.9.nar         |
| [elastic_search](https://pulsar.apache.org/docs/io-connectors) | Writes data into Elastic Search | 2.10.5.9 | pulsar-io-elastic-search-2.10.5.9.nar         |
| [http](https://pulsar.apache.org/docs/io-connectors) | Writes data to an HTTP server (Webhook) | 2.10.5.9 | pulsar-io-http-2.10.5.9.nar                   |
| [jdbc-clickhouse](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for ClickHouse | 2.10.5.9 | pulsar-io-jdbc-clickhouse-2.10.5.9.nar        |
| [jdbc-mariadb](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for MariaDB | 2.10.5.9 | pulsar-io-jdbc-mariadb-2.10.5.9.nar           |
| [jdbc-postgres](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for PostgreSQL | 2.10.5.9 | pulsar-io-jdbc-postgres-2.10.5.9.nar          |
| [jdbc-sqlite](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for SQLite | 2.10.5.9 | pulsar-io-jdbc-sqlite-2.10.5.9.nar            |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.9 | pulsar-io-kafka-2.10.5.9.nar                  |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.9 | pulsar-io-kinesis-2.10.5.9.nar                |
| [snowflake](https://github.com/datastax/snowflake-connector) | Snowflake Connector | 0.1.13   | pulsar-snowflake-connector-0.1.13.nar         |
| [lakehouse](https://github.com/streamnative/pulsar-io-lakehouse) | Lakehouse Connector | 2.10.5.17   | pulsar-io-lakehouse-2.10.5.17.nar         |
| [lakehouse-cloud](https://github.com/streamnative/pulsar-io-lakehouse) | Lakehouse Cloud Connector | 2.10.5.17   | pulsar-io-lakehouse-2.10.5.17-cloud.nar         |
</details>
...
| ---- | ----------- |----------|------------------------------------------|
| [cassandra-source](https://github.com/datastax/cdc-for-apache-cassandra) | Read data from Cassandra | 2.2.9    | pulsar-cassandra-source-2.2.9.nar        |
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.5.9 | pulsar-io-data-generator-2.10.5..nar     |
| [debezium-mongodb](https://pulsar.apache.org/docs/io-connectors) | Debezium MongoDb Source | 2.10.5.9 | pulsar-io-debezium-mongodb-2.10.5.9.nar  |
| [debezium-mssql](https://pulsar.apache.org/docs/io-connectors) | Debezium Microsoft SQL Server Source | 2.10.5.9 | pulsar-io-debezium-mssql-2.10.5.9.nar    |
| [debezium-mysql](https://pulsar.apache.org/docs/io-connectors) | Debezium MySql Source | 2.10.5.9 | pulsar-io-debezium-mysql-2.10.5.9.nar    |
| [debezium-oracle](https://pulsar.apache.org/docs/io-connectors) | Debezium Oracle Source | 2.10.5.9 | pulsar-io-debezium-oracle-2.10.5.9.nar   |
| [debezium-postgres](https://pulsar.apache.org/docs/io-connectors) | Debezium Postgres Source | 2.10.5.9 | pulsar-io-debezium-postgres-2.10.5.9.nar |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.9 | pulsar-io-kafka-2.10.5.9.nar             |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.9 | pulsar-io-kinesis-2.10.5.9.nar           |
</details>
<details><summary>Proxy extensions</summary>
...
## Luna Streaming Distribution 2.10.5.8
This is a maintenance release containing important stability and security updates. It contains upgraded s4k nar files.
...
| [cassandra-enhanced](https://github.com/datastax/pulsar-sink) | A DataStax Pulsar Sink to load records from Pulsar topics to Apache Cassandra(R) or DataStax Enterprise(DSE) | 1.6.11   | cassandra-enhanced-pulsar-sink-1.6.11-nar.nar |
| [cloud-storage](https://github.com/streamnative/pulsar-io-cloud-storage) | Writes data into cloud storage | 2.10.1   | pulsar-io-cloud-storage-2.10.1.nar            |
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.5.8 | pulsar-io-data-generator-2.10.5.8.nar         |
| [elastic_search](https://pulsar.apache.org/docs/io-connectors) | Writes data into Elastic Search | 2.10.5.8 | pulsar-io-elastic-search-2.10.5.8.nar         |
| [http](https://pulsar.apache.org/docs/io-connectors) | Writes data to an HTTP server (Webhook) | 2.10.5.8 | pulsar-io-http-2.10.5.8.nar                   |
| [jdbc-clickhouse](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for ClickHouse | 2.10.5.8 | pulsar-io-jdbc-clickhouse-2.10.5.8.nar        |
| [jdbc-mariadb](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for MariaDB | 2.10.5.8 | pulsar-io-jdbc-mariadb-2.10.5.8.nar           |
| [jdbc-postgres](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for PostgreSQL | 2.10.5.8 | pulsar-io-jdbc-postgres-2.10.5.8.nar          |
| [jdbc-sqlite](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for SQLite | 2.10.5.8 | pulsar-io-jdbc-sqlite-2.10.5.8.nar            |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.8 | pulsar-io-kafka-2.10.5.8.nar                  |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.8 | pulsar-io-kinesis-2.10.5.8.nar                |
| [snowflake](https://github.com/datastax/snowflake-connector) | Snowflake Connector | 0.1.13   | pulsar-snowflake-connector-0.1.13.nar         |
</details>
<details><summary>Sources</summary>
...
| ---- | ----------- |----------|------------------------------------------|
| [cassandra-source](https://github.com/datastax/cdc-for-apache-cassandra) | Read data from Cassandra | 2.2.9    | pulsar-cassandra-source-2.2.9.nar        |
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.5.8 | pulsar-io-data-generator-2.10.5..nar     |
| [debezium-mongodb](https://pulsar.apache.org/docs/io-connectors) | Debezium MongoDb Source | 2.10.5.8 | pulsar-io-debezium-mongodb-2.10.5.8.nar  |
| [debezium-mssql](https://pulsar.apache.org/docs/io-connectors) | Debezium Microsoft SQL Server Source | 2.10.5.8 | pulsar-io-debezium-mssql-2.10.5.8.nar    |
| [debezium-mysql](https://pulsar.apache.org/docs/io-connectors) | Debezium MySql Source | 2.10.5.8 | pulsar-io-debezium-mysql-2.10.5.8.nar    |
| [debezium-oracle](https://pulsar.apache.org/docs/io-connectors) | Debezium Oracle Source | 2.10.5.8 | pulsar-io-debezium-oracle-2.10.5.8.nar   |
| [debezium-postgres](https://pulsar.apache.org/docs/io-connectors) | Debezium Postgres Source | 2.10.5.8 | pulsar-io-debezium-postgres-2.10.5.8.nar |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.8 | pulsar-io-kafka-2.10.5.8.nar             |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.8 | pulsar-io-kinesis-2.10.5.8.nar           |
</details>
<details><summary>Proxy extensions</summary>
...
| [cassandra-enhanced](https://github.com/datastax/pulsar-sink) | A DataStax Pulsar Sink to load records from Pulsar topics to Apache Cassandra(R) or DataStax Enterprise(DSE) | 1.6.11   | cassandra-enhanced-pulsar-sink-1.6.11-nar.nar |
| [cloud-storage](https://github.com/streamnative/pulsar-io-cloud-storage) | Writes data into cloud storage | 2.10.1   | pulsar-io-cloud-storage-2.10.1.nar            |
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.5.7 | pulsar-io-data-generator-2.10.5.7.nar         |
| [elastic_search](https://pulsar.apache.org/docs/io-connectors) | Writes data into Elastic Search | 2.10.5.7 | pulsar-io-elastic-search-2.10.5.7.nar         |
| [http](https://pulsar.apache.org/docs/io-connectors) | Writes data to an HTTP server (Webhook) | 2.10.5.7 | pulsar-io-http-2.10.5.7.nar                   |
| [jdbc-clickhouse](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for ClickHouse | 2.10.5.7 | pulsar-io-jdbc-clickhouse-2.10.5.7.nar        |
| [jdbc-mariadb](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for MariaDB | 2.10.5.7 | pulsar-io-jdbc-mariadb-2.10.5.7.nar           |
| [jdbc-postgres](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for PostgreSQL | 2.10.5.7 | pulsar-io-jdbc-postgres-2.10.5.7.nar          |
| [jdbc-sqlite](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for SQLite | 2.10.5.7 | pulsar-io-jdbc-sqlite-2.10.5.7.nar            |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.7 | pulsar-io-kafka-2.10.5.7.nar                  |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.7 | pulsar-io-kinesis-2.10.5.7.nar                |
| [snowflake](https://github.com/datastax/snowflake-connector) | Snowflake Connector | 0.1.13   | pulsar-snowflake-connector-0.1.13.nar         |
</details>
<details><summary>Sources</summary>
...
| ---- | ----------- |----------|-----------------------------------------|
| [cassandra-source](https://github.com/datastax/cdc-for-apache-cassandra) | Read data from Cassandra | 2.2.9    | pulsar-cassandra-source-2.2.9.nar       |
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.5.7 | pulsar-io-data-generator-2.10.5..nar    |
| [debezium-mongodb](https://pulsar.apache.org/docs/io-connectors) | Debezium MongoDb Source | 2.10.5.7 | pulsar-io-debezium-mongodb-2.10.5.7.nar |
| [debezium-mssql](https://pulsar.apache.org/docs/io-connectors) | Debezium Microsoft SQL Server Source | 2.10.5.7 | pulsar-io-debezium-mssql-2.10.5.7.nar   |
| [debezium-mysql](https://pulsar.apache.org/docs/io-connectors) | Debezium MySql Source | 2.10.5.7 | pulsar-io-debezium-mysql-2.10.5.7.nar   |
| [debezium-oracle](https://pulsar.apache.org/docs/io-connectors) | Debezium Oracle Source | 2.10.5.7 | pulsar-io-debezium-oracle-2.10.5.7.nar  |
| [debezium-postgres](https://pulsar.apache.org/docs/io-connectors) | Debezium Postgres Source | 2.10.5.7 | pulsar-io-debezium-postgres-2.10.5.7.nar |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.7 | pulsar-io-kafka-2.10.5.7.nar            |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.7 | pulsar-io-kinesis-2.10.5.7.nar          |
</details>
<details><summary>Proxy extensions</summary>
...
| [cassandra-enhanced](https://github.com/datastax/pulsar-sink) | A DataStax Pulsar Sink to load records from Pulsar topics to Apache Cassandra(R) or DataStax Enterprise(DSE) | 1.6.11   | cassandra-enhanced-pulsar-sink-1.6.11-nar.nar |
| [cloud-storage](https://github.com/streamnative/pulsar-io-cloud-storage) | Writes data into cloud storage | 2.10.1   | pulsar-io-cloud-storage-2.10.1.nar            |
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.5.6 | pulsar-io-data-generator-2.10.5.6.nar         |
| [elastic_search](https://pulsar.apache.org/docs/io-connectors) | Writes data into Elastic Search | 2.10.5.6 | pulsar-io-elastic-search-2.10.5.6.nar         |
| [http](https://pulsar.apache.org/docs/io-connectors) | Writes data to an HTTP server (Webhook) | 2.10.5.6 | pulsar-io-http-2.10.5.6.nar                   |
| [jdbc-clickhouse](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for ClickHouse | 2.10.5.6 | pulsar-io-jdbc-clickhouse-2.10.5.6.nar        |
| [jdbc-mariadb](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for MariaDB | 2.10.5.6 | pulsar-io-jdbc-mariadb-2.10.5.6.nar           |
| [jdbc-postgres](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for PostgreSQL | 2.10.5.6 | pulsar-io-jdbc-postgres-2.10.5.6.nar          |
| [jdbc-sqlite](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for SQLite | 2.10.5.6 | pulsar-io-jdbc-sqlite-2.10.5.6.nar            |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.6 | pulsar-io-kafka-2.10.5.6.nar                  |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.6 | pulsar-io-kinesis-2.10.5.6.nar                |
| [snowflake](https://github.com/datastax/snowflake-connector) | Snowflake Connector | 0.1.13   | pulsar-snowflake-connector-0.1.13.nar         |
</details>
<details><summary>Sources</summary>
...
| [cassandra-source](https://github.com/datastax/cdc-for-apache-cassandra) | Read data from Cassandra | 2.2.9    | pulsar-cassandra-source-2.2.9.nar        |
| [data-generator](https://pulsar.apache.org/docs/io-connectors) | Test data generator source | 2.10.5.6 | pulsar-io-data-generator-2.10.5.6.nar    |
| [debezium-mongodb](https://pulsar.apache.org/docs/io-connectors) | Debezium MongoDb Source | 2.10.5.6 | pulsar-io-debezium-mongodb-2.10.5.6.nar  |
| [debezium-mssql](https://pulsar.apache.org/docs/io-connectors) | Debezium Microsoft SQL Server Source | 2.10.5.6 | pulsar-io-debezium-mssql-2.10.5.6.nar    |
| [debezium-mysql](https://pulsar.apache.org/docs/io-connectors) | Debezium MySql Source | 2.10.5.6 | pulsar-io-debezium-mysql-2.10.5.6.nar    |
| [debezium-oracle](https://pulsar.apache.org/docs/io-connectors) | Debezium Oracle Source | 2.10.5.6 | pulsar-io-debezium-oracle-2.10.5.6.nar   |
| [debezium-postgres](https://pulsar.apache.org/docs/io-connectors) | Debezium Postgres Source | 2.10.5.6 | pulsar-io-debezium-postgres-2.10.5.6.nar |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.6 | pulsar-io-kafka-2.10.5.6.nar             |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.6 | pulsar-io-kinesis-2.10.5.6.nar           |
</details>
<details><summary>Proxy extensions</summary>
...
## Luna Streaming Distribution 2.10.5.5
...
| [elastic_search](https://pulsar.apache.org/docs/io-connectors) | Writes data into Elastic Search | 2.10.5.5 | pulsar-io-elastic-search-2.10.5.5.nar |
| [http](https://pulsar.apache.org/docs/io-connectors) | Writes data to an HTTP server (Webhook) | 2.10.5.5 | pulsar-io-http-2.10.5.5.nar |
| [jdbc-clickhouse](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for ClickHouse | 2.10.5.5 | pulsar-io-jdbc-clickhouse-2.10.5.5.nar |
| [jdbc-mariadb](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for MariaDB | 2.10.5.5 | pulsar-io-jdbc-mariadb-2.10.5.5.nar |
| [jdbc-postgres](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for PostgreSQL | 2.10.5.5 | pulsar-io-jdbc-postgres-2.10.5.5.nar |
| [jdbc-sqlite](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for SQLite | 2.10.5.5 | pulsar-io-jdbc-sqlite-2.10.5.5.nar |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.5 | pulsar-io-kafka-2.10.5.5.nar |
...
| [debezium-mssql](https://pulsar.apache.org/docs/io-connectors) | Debezium Microsoft SQL Server Source | 2.10.5.5 | pulsar-io-debezium-mssql-2.10.5.5.nar |
| [debezium-mysql](https://pulsar.apache.org/docs/io-connectors) | Debezium MySql Source | 2.10.5.5 | pulsar-io-debezium-mysql-2.10.5.5.nar |
| [debezium-oracle](https://pulsar.apache.org/docs/io-connectors) | Debezium Oracle Source | 2.10.5.5 | pulsar-io-debezium-oracle-2.10.5.5.nar |
| [debezium-postgres](https://pulsar.apache.org/docs/io-connectors) | Debezium Postgres Source | 2.10.5.5 | pulsar-io-debezium-postgres-2.10.5.5.nar |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.5 | pulsar-io-kafka-2.10.5.5.nar |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.5 | pulsar-io-kinesis-2.10.5.5.nar |
</details>
<details><summary>Proxy extensions</summary>
...
| [elastic_search](https://pulsar.apache.org/docs/io-connectors) | Writes data into Elastic Search | 2.10.5.4 | pulsar-io-elastic-search-2.10.5.4.nar |
| [http](https://pulsar.apache.org/docs/io-connectors) | Writes data to an HTTP server (Webhook) | 2.10.5.4 | pulsar-io-http-2.10.5.4.nar |
| [jdbc-clickhouse](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for ClickHouse | 2.10.5.4 | pulsar-io-jdbc-clickhouse-2.10.5.4.nar |
| [jdbc-mariadb](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for MariaDB | 2.10.5.4 | pulsar-io-jdbc-mariadb-2.10.5.4.nar |
| [jdbc-postgres](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for PostgreSQL | 2.10.5.4 | pulsar-io-jdbc-postgres-2.10.5.4.nar |
| [jdbc-sqlite](https://pulsar.apache.org/docs/io-connectors) | JDBC sink for SQLite | 2.10.5.4 | pulsar-io-jdbc-sqlite-2.10.5.4.nar |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.4 | pulsar-io-kafka-2.10.5.4.nar |
...
| [debezium-mssql](https://pulsar.apache.org/docs/io-connectors) | Debezium Microsoft SQL Server Source | 2.10.5.4 | pulsar-io-debezium-mssql-2.10.5.4.nar |
| [debezium-mysql](https://pulsar.apache.org/docs/io-connectors) | Debezium MySql Source | 2.10.5.4 | pulsar-io-debezium-mysql-2.10.5.4.nar |
| [debezium-oracle](https://pulsar.apache.org/docs/io-connectors) | Debezium Oracle Source | 2.10.5.4 | pulsar-io-debezium-oracle-2.10.5.4.nar |
| [debezium-postgres](https://pulsar.apache.org/docs/io-connectors) | Debezium Postgres Source | 2.10.5.4 | pulsar-io-debezium-postgres-2.10.5.4.nar |
| [kafka](https://pulsar.apache.org/docs/io-connectors) | Kafka source and sink connector | 2.10.5.4 | pulsar-io-kafka-2.10.5.4.nar |
| [kinesis](https://pulsar.apache.org/docs/io-connectors) | Kinesis connectors | 2.10.5.4 | pulsar-io-kinesis-2.10.5.4.nar |
</details>
<details><summary>Proxy extensions</summary>
