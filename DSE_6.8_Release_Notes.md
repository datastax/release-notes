...
* Added an expanded redaction flag for Apache Solr to improve security. Without the fix, the `/admin/info/properties` endpoint might display Java system properties on the home screen of the Solr Admin page and expose sensitive credentials in the UI. As a workaround, do the following:. (DSP-24474, [CVE-2023-50291](https://nvd.nist.gov/vuln/detail/CVE-2023-50291))
